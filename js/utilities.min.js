    ...
    _createClass(ActiveMenu, [{
        ...
        value: function addActive(navbarParam) {
            ...
            location.pathname[location.pathname.length - 1] == "/" ? navbarParam[0].classList.add(this.activeClass) : navbarParam.forEach(function(e) {
                if (e.attributes[1].value.includes("../") && e.attributes[1].value.slice(3) == _this.path)
                    e.classList.add(_this.activeClass);
                if (e.attributes[1].value == _this.path)
                    e.classList.add(_this.activeClass);
                if (_this.path.includes("blog-page") && e.attributes[1].value == _this.blogPath)
                    e.classList.add(_this.activeClass)
            })
        }
    }, {
        ...
        value: function createCategoryWidget(data) {
            ...
            if (document.querySelector(".widget-categories") !== null) {
                ...
                categoryFilter.forEach(function(eachData) {
                    _this8.categoryWrap.innerHTML += "<li><a href=\"blog-find.html?category=".concat(eachData.category.toLowerCase(), "\" class=\"link-dark text-decoration-none d-flex justify-content-between align-items-center\">").concat(eachData.category, "<span class=\"badge rounded-1\">").concat(eachData.totalPost, "</span></a></li>")
                })
            }
        }
    }, {
        ...
        value: function createTagWidget(data) {
            ...
            if (document.querySelector(".widget-tag") !== null) {
                ...
                tagFilter.forEach(function(eachTag) {
                    if (eachTag.length !== 0) {
                        _this10.tagWrap.innerHTML += "<a href=\"blog-find.html?tag=".concat(eachTag, "\"><span class=\"badge rounded-pill\">#").concat(eachTag, "</span></a>")
                    } else {
                        _this10.tagWrap.innerHTML = "<small class=\"text-muted\">No tags available yet</small>"
                    }
                })
            }
        }
        ...
        value: function createFindPage(data) {
            ...
            if (document.querySelector("[data-title=\"blog-find\"]")) {
                ...
                if (params.has("category")) {
                    ...
                    headingEl.innerHTML = "<i class=\"fas fa-folder-open fa-xs me-1 position-relative\" style=\"top: 3px;\"></i>".concat(categoryName);
                ...
                if (params.has("tag")) {
                    ...
                    headingEl.innerHTML = "<i class=\"fas fa-tag fa-xs me-1 position-relative\" style=\"top: 3px;\"></i>".concat(tagName);
        ...
        value: function searchProcess(data) {
            ...
            if (document.querySelector("[data-title=\"blog-find\"]") && params.has("result")) {
                data.forEach(function(post) {
                    ...
                    headingEl.innerHTML = "<i class=\"fas fa-search fa-xs me-1 position-relative\" style=\"top: 3px;\"></i>".concat(params.get("result"));
        ...
        value: function trimLatestWidget() {
            ...
            if (document.querySelector(".widget-latest") !== null) {
                ...
                titleList.forEach(function(title) {
                    return title.textContent = _this13.trimLongTitle(title.textContent, 55)
                })
            }
        }
    }, {
...
var CarouselConfig = function() {
    ...
    _createClass(CarouselConfig, [{
        ...
        value: function generateIndicator(carouselWrap, carouselItem, carouselId) {
    ...
    _createClass(ContactForm, [{
        ...
        value: function init() {
            ...
            document.addEventListener("DOMContentLoaded", function() {
                if (typeof _this16.buttonSend !== "undefined" && _this16.buttonSend !== null) {
                    _this16.buttonSend.addEventListener("click", function(event) {
                        ...
                        _this16.ajaxRequest("POST", "./sendmail.php", postdata, function(success, response) {
                            if (success) {
            ...
            if (document.querySelector(".".concat(this.navbarName)) !== null) {
                ...
                window.addEventListener("scroll", function() {
                    if (_this19.showOnUp) {
                        ...
                        window.scrollY > 350 ? _this19.stickyNav.classList.add("active") : _this19.stickyNav.classList.remove("active")
                    }
                })
            }
        }
    ...
    _createClass(ToTop, [{
        ...
        value: function init() {
            if (document.querySelector(".".concat(this.elementName)) !== null) {
                ...
                window.addEventListener("scroll", function() {
                    setTimeout(function() {
                        window.scrollY > 350 ? (inTotop.style.opacity = 1,
                        inTotop.classList.add("to-top-animation")) : (inTotop.style.opacity -= .1,
